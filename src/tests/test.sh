...
echo ----------------------------------------------*GREP 10 BONUS
diff <(grep -s int aboba) <(./s21_grep -s int aboba) -s -q
echo ----------------------------------------------*GREP 11 BONUS
diff <(grep -f "$filename1" "$filename2") <(./s21_grep -f "$filename1" "$filename2") -s -q
echo ----------------------------------------------*GREP 12 BONUS
...
echo ----------------------------------------------*GREP 17 BONUS
diff <(grep -oi int "$filename2") <(./s21_grep -oi int "$filename2") -s -q
echo ----------------------------------------------*GREP 18 BONUS
diff <(grep -nf "$filename1" "$filename2") <(./s21_grep -nf "$filename1" "$filename2") -s -q